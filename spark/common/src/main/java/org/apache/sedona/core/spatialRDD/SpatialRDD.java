...
public class SpatialRDD<T extends Geometry> implements Serializable {
  ...
  public void calc_partitioner(GridType gridType, int numPartitions) throws Exception {
    ...
    switch (gridType) {
      ...
      case ImprovedQT:
        {
          ImprovedQuadtreePartitioning quadtreePartitioning =
              new ImprovedQuadtreePartitioning(this, numPartitions);
  ...
  public void calc_partitioner(GridType gridType, int numPartitions, boolean needSample)
      throws Exception {
    if (needSample) {
    ...
    switch (gridType) {
      ...
      case Hilbert:
        {
          HilbertPartitioning hilbertPartitioning =
              new HilbertPartitioning(data, paddedBoundary, numPartitions);
  ...
  public void spatialPartitioning(GridType gridType, int numPartitions, boolean needSample)
      throws Exception {
